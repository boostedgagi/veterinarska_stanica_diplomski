...
class HealthRecordControllerTest extends WebTestCase
{
    ...
    public function testPetHealthRecords(): void
    {
        $client = static::createClient();
        $response = RequestBuilder::create($client)
            ->setMethod('GET')
        ...
        self::assertArrayHasKey('items',$response->getJsonContent());
        self::assertArrayHasKey('currentPageNumber',$response->getJsonContent());
        self::assertArrayHasKey('totalItemsCount',$response->getJsonContent());
    }
